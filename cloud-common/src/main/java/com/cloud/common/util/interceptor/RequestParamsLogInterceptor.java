package com.cloud.common.util.interceptor;

import com.cloud.common.util.AppUtils;
...
public class RequestParamsLogInterceptor implements HandlerInterceptor {
    private final static Logger logger = LoggerFactory.getLogger(RequestParamsLogInterceptor.class);
